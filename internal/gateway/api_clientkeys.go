...
func clientKeyView(k store.ClientKey) clientKeyJSON {
...
func (g *gateway) createKeyFor(w http.ResponseWriter, r *http.Request, actor *store.User, targetUserID int64) {
	var req struct {
		Alias string `json:"alias"`
	}
	if !readJSON(w, r, &req) {
